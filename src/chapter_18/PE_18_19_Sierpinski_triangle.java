 ...
 * button is ignored.
 */
public class PE_18_19_Sierpinski_triangle extends Application {
    /**
    ...
    public void start(Stage primaryStage) {
        ...
        buttonMinus.setOnAction(event -> changeOrder(trianglePane, -1));
        buttonPlus.setOnAction(event -> changeOrder(trianglePane, 1));

        // Pane to hold label, text field, and a button
        HBox hBox = new HBox(10);
        hBox.getChildren().addAll(buttonMinus, buttonPlus);
    ...
    private void changeOrder(SierpinskiTrianglePane trianglePane, int change) {
        int newOrder = trianglePane.getOrder() + change;
        if (newOrder >= 0) {
