 ...
 */
public class PE_22_21_Game_Sudoku extends Application {
    ...
    class SudokuSolverPane extends BorderPane {
        ...
        private Node createButtonPane() {
            HBox hBox = new HBox(SPACING, buttonSolve, buttonClear);
        ...
        private void solve() {
            ...
            List<int[][]> solutions = sudokuSolver.search(grid);
            if (solutions.isEmpty()) label.setText("Invalid Input");
            else {
                int solutionIndex = (int) (Math.random() * solutions.size());
